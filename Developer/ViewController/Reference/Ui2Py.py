...
import re
import subprocess
#import project-font-tool
'''process = subprocess.Popen(['project-font-tool', '-script', '/home/max/Projects/Python/GlyphTracer/glyphtracer-1.4/glyphtracer.py'],
...
def runsubproc(uifile,pyfile):
    print(uifile,pyfile)
    #print('pyuic5 -x -o')
    #os.system('project-font-tool -script /home/max/Projects/Python/GlyphTracer/glyphtracer-1.4/glyphtracer.py')
