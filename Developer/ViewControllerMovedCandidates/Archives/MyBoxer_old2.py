...
from PyQt5.QtWidgets import  QSpinBox, QListWidget, QListWidgetItem, QRubberBand, QWidget, QHBoxLayout, QSizeGrip, QMenu
...
class MainWindow(qtw.QMainWindow):
    ...
    def on_rowSelection(self):
        ...
        deleteIcon.addPixmap(qtg.QPixmap("/home/max/Projects/BiblionOCR/ViewController/Application/0-MainUI/Icons/cross-small.png"), qtg.QIcon.Normal, qtg.QIcon.Off)
    ...
    def resetLineBox(self):
        ...
        self.pixmap = qtg.QPixmap.fromImage(self.norm).scaled(self.ui.Image.size(), qtc.Qt.KeepAspectRatio)        
        self.on_zoom()
        #self.saveLineBoxImage()
        #self.showImage(self.boximgpath)
