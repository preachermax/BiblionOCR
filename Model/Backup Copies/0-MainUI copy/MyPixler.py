...
# Session View
    ...
    def get_session_settings(self):
        ...
        # Define json data
        print("importing MainWindow session settings: imgpath and imgdir")
        ...
        with open('/home/max/Projects/BiblionOCR/Model/Data/json/PixlerSession.json') as f:
            # returns JSON object as a dictionary
            data = json.load(f)
    ...
    def showRefImg(self,imgfilename):
        ...
        jsonfile = '/home/max/Projects/BiblionOCR/Model/Data/json/PixlerSession.json'
