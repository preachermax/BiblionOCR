...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.EditCorrectedTextbutton.clicked.connect(self.my_OpenDialog)
        
        self.SaveOCRTextbutton = QtWidgets.QPushButton(self.centralwidget)
        self.SaveOCRTextbutton.setEnabled(True)
        self.SaveOCRTextbutton.setGeometry(QtCore.QRect(540, 100, 201, 25))
        self.SaveOCRTextbutton.setObjectName("SaveOCRTextbutton")
    ...
    def my_OpenDialog(self, MainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.SaveOCRTextbutton.setText(_translate("MainWindow", "Save Raw Text File"))
