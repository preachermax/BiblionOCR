...
conn_TW = sqlite3.connect('/home/max/Projects/Python/SQLite/TR-Words_TW.db')
    ...
    for match in matches:
        ...
        insert_parameters = """INSERT INTO Bible 
                            (Line,Book,Chapter,Verse,WordNum,WordOpen,Word,WordClose,StrongOpen,Strong,StrongClose,RMACOpen,RMAC,RMACClose,LemmaOpen,Lemma,LemmaClose,WordPunc)
                             VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"""
        insert_data = (linenum,book,chpt,vrse,wordnum,word_open,word,word_open,strong_open,strong,strong_close,rmac_open,rmac,rmac_close,lemma_open,lemma,lemma_close,punc)
