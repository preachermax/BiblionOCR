...
conn_TW = sqlite3.connect('/home/max/Projects/Python/SQLite/TRa-Words_Esword.db')
...
conn_TR = sqlite3.connect('/home/max/Projects/Python/SQLite/TRa.db')
...
for vline in vlines:
    ...
    pattern = re.compile(r"(<wt>)((\\\\u\d+\?)+)(<)(W)(G\d+)(>)")
    #pattern = re.compile('(<wt>)(\\u\d+\?)+(\s)')
    ...
    for match in matches:
        ...
        insert_parameters = '''INSERT INTO Bible 
                            (BookNum,Chapter,Verse,WordNum,WordOpen,Word,WordClose,StrongOpen,Strong,StrongClose)
                             VALUES (?,?,?,?,?,?,?,?,?,?)'''
        insert_data = (booknum,chpt,vrse,wordnum,word_open,uword,word_close,strong_open,strong,strong_close)
        ...
        print(str(booknum) + " " + str(chpt) + ":" + str(vrse) + ":" + str(wordnum) + " " + uword + " " + match.group(6))
        #print(str(booknum) + " " + str(chpt) + ":" + str(vrse) + ":" + str(wordnum) + " " + match.group(2) + " " + match.group(6))
