...
#txtfile = open('/home/max/Projects/Python/TheWord/ERASMS1516+.nt', 'w', encoding='utf-8-sig')
...
while loopcount <= lastline:
    cursor_TW.execute("SELECT Line,Word,Strong FROM Bible WHERE Line = " + str(loopcount))
    ...
    for vword in vwords:
        if vword:
            ...
            wordgroup = wordopen + str(word) + strongopen + str(strong) + strongclose + str(punc)
...
# Append footer
#footfile = open('/home/max/Projects/BiblionOCR/Model/Project/Text/TheWord/TW_footerInt+.txt', 'r', encoding='utf-8-sig')
#txtfile = open('/home/max/Projects/BiblionOCR/Model/Project/Text/TheWord/ERASMS1516Int+.nt', 'a+', encoding='utf-8-sig')
