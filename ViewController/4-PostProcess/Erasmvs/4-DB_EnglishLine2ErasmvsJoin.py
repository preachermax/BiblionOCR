...
cursor_TW.execute("Select f.ID, f.Line, f.Book, f.Chapter, f.Verse, i.WordNum,f.WordNum, i.Word,f.Word, i.NoDiaWord,f.NoDiaWord, i.Strong,f.Strong, i.RMAC,f.RMAC, i.English, f.English, i.EnglishPunc, f.EnglishPunc from Bible as f Left Join IntBibleWords as i on f.Line == i.Line and f.NoDiaWord == i.NoDiaWord Where f.VarWord == i.NoDiaWord Or f.WordNum == i.WordNum")
