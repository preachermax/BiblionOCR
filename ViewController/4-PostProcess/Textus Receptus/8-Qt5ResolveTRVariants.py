...
def updateone():   
    ...
    data = (varword,strong,rmac,lemma,varcode,errorcode,desc,varform,vartype,impactcode,preserved,Corrected,error,variance,context,inflection,resolved,line,wordnum)
    #startProgressBar()
...
def updatebible():
    ...
    query = '''SELECT Line,WordNum,VarWord,Strong,RMAC,Lemma,VarCode FROM Variants WHERE Preserved = "1"'''
