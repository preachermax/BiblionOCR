...
# Menu and Toolbar Action Methods 
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self.ui.chapterComboBox.currentTextChanged.connect(self.selectChapterCombo)
        ...
        #self.ui.chapterComboBox.setCurrentText(self.chapter)
...
'''
    def loadChapterCombo(self):
        self.ui.chapterComboBox.setCurrentText(self.chapter)
        # Opening JSON file
        with open('/home/max/Projects/BiblicalOCR/Model/Data/json/BookChapter.json') as f:
            # returns JSON object as
            # a dictionary
            data = json.load(f)
        ...
        for line in data:
            if line['bookabbr'] == self.ui.bookComboBox.currentText():
            #if line['bookabbr'] == self.bookabbr:
                self.ui.chapterComboBox.addItem(str(line['chapter']))
        
        # Closing file
        f.close()

    def selectChapterCombo(self):
                
        self.chapter = self.ui.chapterComboBox.currentText()
        ...
        with open(jsonfile, 'r') as f:
            ...
            chapter_key = r"self.chapter"
            for Setting in data:
                if Setting['Setting'] == chapter_key:
