...
class MainWindow(qtw.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ui.actionMake_Greek_GlyphBox_Files.triggered.connect(self.linebox_make_split)
        self.ui.actionEdit_Greek_GlyphBox_Files.triggered.connect(self.linebox_edit_split)
