...
class Find(QtWidgets.QDialog):
    ...
    def find(self):
        ...
        text = self.parent.ui.OCRText.toPlainText()
        ...
        if self.normalRadio.isChecked():
            ...
            if self.lastStart >= 0:
                ...
                self.parent.ui.OCRText.moveCursor(QtGui.QTextCursor.End)
    ...
    def replace(self):
        ...
        cursor = self.parent.ui.OCRText.textCursor()
        ...
        if cursor.hasSelection():
            ...
            self.parent.ui.OCRText.setTextCursor(cursor)
    ...
    def moveCursor(self,start,end):
        ...
        self.parent.ui.textEdit.setTextCursor(cursor)
