...
from MyBoxerGVUI import Ui_BoxerGV
...
class MainWindow(qtw.QMainWindow):
    ...
    def resize_image(self):
        ...
        # Display scaled box image file in Graphics View
        self.scene.clear()
        self.pixmap = qtw.QGraphicsPixmapItem()
        self.pixmap.setPixmap(scaled_pixmap)
        self.scene.addItem(self.pixmap)
        #self.ui.Image.fitInView(qtc.QRect(self.pixmap.size()), qtc.Qt.KeepAspectRatio)
        #self.scene.update()
    ...
    def linebox_make_split(self):
            #dest_of_autosplit = splitdir
            #dest_of_linebox = linebox
            #path_of_image = imagepath self.imgpath
            #dest_of_autosplit = "/home/max/Projects/BiblionOCR/Model/Images/Workflow/Greek/tif_greek_lines_autosplit_copy/"
            #dest_of_linebox = "/home/max/Projects/BiblionOCR/Model/Images/Workflow/Greek/tif_greek_lines_box_copy/"
            #path_of_image = "/home/max/Projects/BiblionOCR/Model/Images/Workflow/Greek/tif_greek_pages/" + "greek1516_Page_125.tif"
            dest_of_autosplit = self.greeklinesautosplit + r"/"
            dest_of_linebox = self.greeklinesbox + r"/"
            path_of_image = self.imgpath
            dosplit = True
            #if splitlines == True:
                #dosplit = True
            print(f"dest_of_autosplit: {dest_of_autosplit}")
            print(f"dest_of_linebox: {dest_of_linebox}")
