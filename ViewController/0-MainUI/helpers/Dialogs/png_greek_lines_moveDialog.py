...
# Form implementation generated from reading ui file './QtDesignerUI/png_greek_lines_moveDialog.ui'
#
...
class Ui_greekmovelinespngDialog(object):
    ...
    def retranslateUi(self, greekmovelinespngDialog):
        ...
        greekmovelinespngDialog.setWindowTitle(_translate("greekmovelinespngDialog", "Rename Greek png lines"))
        ...
        self.SourceLabel.setText(_translate("greekmovelinespngDialog", "Rename Greek png lines source folder"))
        self.DestinationLabel.setText(_translate("greekmovelinespngDialog", "Rename Greek png lines destination folder"))
