...
class Ui_ExtractDialog(object):
    def setupUi(self, ExtractDialog):
        ...
        ExtractDialog.setWindowModality(QtCore.Qt.NonModal)
        ExtractDialog.resize(620, 350)
        ExtractDialog.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.buttonBox = QtWidgets.QDialogButtonBox(ExtractDialog)
        self.buttonBox.setGeometry(QtCore.QRect(420, 300, 181, 32))
        ...
        self.MakeDefaultCheckBox = QtWidgets.QCheckBox(ExtractDialog)
        self.MakeDefaultCheckBox.setEnabled(False)
        self.MakeDefaultCheckBox.setGeometry(QtCore.QRect(330, 80, 181, 23))
        self.MakeDefaultCheckBox.setObjectName("MakeDefaultCheckBox")
        self.MilestoneOverrideCheckBox = QtWidgets.QCheckBox(ExtractDialog)
        self.MilestoneOverrideCheckBox.setGeometry(QtCore.QRect(330, 105, 181, 23))
        self.MilestoneOverrideCheckBox.setObjectName("MilestoneOverrideCheckBox")
        self.ProgressLabel = QtWidgets.QLabel(ExtractDialog)
        self.ProgressLabel.setGeometry(QtCore.QRect(20, 210, 581, 20))
        self.ProgressLabel.setObjectName("ProgressLabel")
        self.PreviousButton = QtWidgets.QPushButton(ExtractDialog)
        self.PreviousButton.setGeometry(QtCore.QRect(20, 250, 100, 32))
        self.PreviousButton.setObjectName("PreviousButton")
        self.NextButton = QtWidgets.QPushButton(ExtractDialog)
        self.NextButton.setGeometry(QtCore.QRect(130, 250, 100, 32))
        self.NextButton.setObjectName("NextButton")
        self.SkipButton = QtWidgets.QPushButton(ExtractDialog)
        self.SkipButton.setGeometry(QtCore.QRect(240, 250, 100, 32))
        self.SkipButton.setObjectName("SkipButton")
        self.HelpButton = QtWidgets.QPushButton(ExtractDialog)
        self.HelpButton.setGeometry(QtCore.QRect(350, 250, 100, 32))
    ...
    def retranslateUi(self, ExtractDialog):
        ...
        self.MakeDefaultCheckBox.setText(_translate("ExtractDialog", "Make this the default"))
        self.MilestoneOverrideCheckBox.setText(_translate("ExtractDialog", "Milestone override"))
        self.ProgressLabel.setText(_translate("ExtractDialog", "Section extraction progress"))
        self.PreviousButton.setText(_translate("ExtractDialog", "Previous"))
        self.NextButton.setText(_translate("ExtractDialog", "Next"))
        self.SkipButton.setText(_translate("ExtractDialog", "Skip"))
        self.HelpButton.setText(_translate("ExtractDialog", "Help"))
