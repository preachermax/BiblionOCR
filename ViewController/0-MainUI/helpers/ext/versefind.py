...
class Find(QtWidgets.QDialog):
    ...
    def initUI(self):
        ...
        self.setWindowTitle("Verse Find and Replace")
    ...
    def find(self):
        ...
        text = self.parent.ui.VerseText.toPlainText()
        ...
        if self.normalRadio.isChecked():
            ...
            if self.lastStart >= 0:
                ...
                self.parent.ui.VerseText.moveCursor(QtGui.QTextCursor.End)
    ...
    def replace(self):
        ...
        cursor = self.parent.ui.VerseText.textCursor()
        ...
        if cursor.hasSelection():
            ...
            self.parent.ui.VerseText.setTextCursor(cursor)
