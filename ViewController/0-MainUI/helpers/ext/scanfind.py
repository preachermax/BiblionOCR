...
class Find(QtWidgets.QDialog):
    ...
    def initUI(self):
        ...
        self.setWindowTitle("Page Find and Replace")
    ...
    def find(self):
        ...
        text = self.parent.ui.PageText.toPlainText()
        ...
        if self.normalRadio.isChecked():
            ...
            if self.lastStart >= 0:
                ...
                self.parent.ui.PageText.moveCursor(QtGui.QTextCursor.End)
    ...
    def replace(self):
        ...
        cursor = self.parent.ui.PageText.textCursor()
        ...
        if cursor.hasSelection():
            ...
            self.parent.ui.PageText.setTextCursor(cursor)
