...
class Find(QtWidgets.QDialog):
    ...
    def find(self):
        ...
        text = self.parent.ui.RefText.toPlainText()
        ...
        if self.normalRadio.isChecked():
            ...
            if self.lastStart >= 0:
                ...
                self.parent.ui.RefText.moveCursor(QtGui.QTextCursor.End)
    ...
    def replace(self):
        ...
        cursor = self.parent.ui.RefText.textCursor()
        ...
        if cursor.hasSelection():
            ...
            self.parent.ui.RefText.setTextCursor(cursor)
