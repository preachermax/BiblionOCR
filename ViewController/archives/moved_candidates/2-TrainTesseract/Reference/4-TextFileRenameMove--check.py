...
dest_of_textfiles = r"/home/max/Projects/BiblicalOCR/Model/Text/EstablishTruth/GreekTemp/"
path_of_textfiles = r"/home/max/Projects/BiblicalOCR/Model/Text/EstablishTruth/Greek_txt_pages/greek_book_41_Mark/"
...
for textfile in list_of_textfiles:
    ...
    print(language + versionref + "_Page_" + pagestr + fileext)
           
    shutil.copy(path_of_textfiles + filestr, dest_of_textfiles + language + versionref + "_Page_" + pagestr + fileext)  