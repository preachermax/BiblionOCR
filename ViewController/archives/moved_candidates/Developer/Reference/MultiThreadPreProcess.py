...
from qtc import QObject, QThread, pyqtSignal
#print(len(locals()))

class PreProcess(QThread):
    pass

class ExtractPdf4Tiff(QObject):
    finished = pyqtSignal()
...
class ConvertTiff2PngIdx(QObject): 
