...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        #self.ImageAreaTitlelabel.setGeometry(QtCore.QRect(10, 0, 171, 25))
        ...
        #self.OCRTextAreaTitlelabel.setGeometry(QtCore.QRect(1149, 0, 141, 25))
        ...
        #self.ChrRefTitlelabel.setGeometry(QtCore.QRect(560, 260, 141, 25))
        #self.ChrRefTitlelabel.setObjectName("ChrRefTitlelabel")
        
        self.ImagescrollArea = QtWidgets.QScrollArea(self.centralwidget)
        self.ImagescrollArea.setGeometry(QtCore.QRect(0, 26, 520, 700))
        ...
        self.ChrRefscrollArea.setGeometry(QtCore.QRect(530, 26, 220, 500))
        ...
        self.OCRTextscrollArea.setGeometry(QtCore.QRect(760, 26, 540, 700))
