...
for vline in vlines:
    ...
    for match in matches:
        ...
        insert_parameters = '''INSERT INTO Bible 
                            (BookNum,Chapter,Verse,WordNum,WordOpen,Word,WordClose,StrongOpen,Strong)
                             VALUES (?,?,?,?,?,?,?,?,?)'''
        insert_data = (booknum,chpt,vrse,wordnum,word_open,word,word_close,strong_open,strong)
