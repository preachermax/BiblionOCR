...
# Session functions
    ...
    def get_xref_last_image(self):
        ...
        if not os.path.isdir(imgdir):
            print(f"Grounder startup: image directory not found: {imgdir}")
            self.imgpath = ""
            return
        if not os.path.exists(xrefjsonfile):
...
# Line image functions
    ...
    def getImage(self, imgpath):
            ...
            if not os.path.isdir(self.imgdirname):
                print(f"Grounder startup: image parent directory not found: {self.imgdirname}")
                return
            self.imgfileList = []
