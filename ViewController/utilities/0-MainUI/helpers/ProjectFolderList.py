...
Run from anywhere inside the repository:
    python ViewController/0-MainUI/helpers/ProjectFolderList.py
...
REQUIRED_VIEWCONTROLLER_REFERENCES = {
    ...
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/update_UI_Resources.txt",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/update_fonts.txt",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/update_fonts.py",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/Ui2Py.py",
    "ViewController/0-MainUI/helpers/UI_Icons.qrc",
    "ViewController/0-MainUI/helpers/UI_Icons.py",
    "ViewController/0-MainUI/helpers/Training.py",
    "ViewController/0-MainUI/helpers/tift2mono.py",
    "ViewController/0-MainUI/helpers/tif_greek_lines_stageDialog.py",
    "ViewController/0-MainUI/helpers/TextDragandDrop.py",
    "ViewController/0-MainUI/helpers/StageLineImages2GroundTruth.py",
    "ViewController/0-MainUI/helpers/SqliteMain.py",
    "ViewController/0-MainUI/helpers/SqliteHelper.py",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/sqlite3-mysql.txt",
    "ViewController/0-MainUI/helpers/RenameFiles.py",
    "ViewController/0-MainUI/helpers/README_HELP_SYSTEM.md",
    "ViewController/0-MainUI/helpers/QUICK_REFERENCE.md",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/pyTesseractTrainer-1.03.py",
    ...
    "ViewController/0-MainUI/helpers/DESIGN_SPECIFICATION.md",
    "ViewController/0-MainUI/helpers/PROJECT_ARCHITECTURE.md",
    "ViewController/0-MainUI/helpers/PreviewStudio.py",
    "ViewController/0-MainUI/helpers/PreProcess.py",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/PageVerseHelper.ipynb",
    "ViewController/0-MainUI/helpers/PageVerseCrossReferenceUI.py",
    "ViewController/0-MainUI/helpers/PageVerseCrossReference.py",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/PageVerseCrossReference.ipynb",
    "ViewController/0-MainUI/helpers/ocr_preprocess_tool.ui",
    ...
    *PROJECT_MANIFEST_TEMPLATE_OVERRIDES,
    ...
    "ViewController/0-MainUI/helpers/main.py",
    "ViewController/0-MainUI/helpers/LICENSE",
    "ViewController/0-MainUI/helpers/lexicon core.py",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/keepforundo",
    "ViewController/0-MainUI/helpers/ImagePreviewDialog.py",
    "ViewController/0-MainUI/helpers/ImageLoadWorker.py",
    "ViewController/0-MainUI/helpers/ImageFileRenameMove4GroundTruth.py",
    "ViewController/0-MainUI/helpers/HelpSystem.py",
    "ViewController/0-MainUI/helpers/HELP_INTEGRATION_GUIDE.md",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/getPlatform.py",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/getFontInfo.py",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/font_glyf2csv2json.py",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/font_glyf_splines2csv2json.py",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/font_cmap2csv2json.py",
    "ViewController/0-MainUI/helpers/find.py",
    "ViewController/0-MainUI/helpers/FileExplorer.py",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/DragandDropNotes.txt",
    "ViewController/0-MainUI/helpers/DragandDrop.py",
    "ViewController/0-MainUI/helpers/dev_notebook.md",
    "ViewController/0-MainUI/helpers/DEPENDENCIES_AND_RELATIONSHIPS.md",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/commit_checklist.md",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/Co-pilot Instructions.txt",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/Co-pilot Instructions.odt",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/Co-pilot diff text on FROMVS in Windows.txt",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/cmap2csv2 json.py",
    "ViewController/0-MainUI/helpers/ChrReferenceDialog.py",
    "ViewController/0-MainUI/helpers/ChrReference.py",
    "ViewController/Developer/SeparatedDevFiles/0-MainUI/AIcommitWorkflow.md",
    "ViewController/0-MainUI/helpers/Adjust.py",
    "ViewController/0-MainUI/helpers/UI_Images",
    "ViewController/0-MainUI/helpers/web",
}
...
class ProjectFolderListBuilder:
    ...
    def build(self, include_existing: bool = True, scan_filesystem: bool = False) -> list[str]:
        ...
        folders.add("ViewController/0-MainUI/helpers/fonts")
