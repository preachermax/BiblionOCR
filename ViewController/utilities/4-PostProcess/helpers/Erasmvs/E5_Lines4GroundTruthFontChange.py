...
path_of_textfiles = r"/home/max/Projects/Python/FontChange/Greek lines4groundtruth/"
...
for tfile in list_of_textfiles:
    ...
    for row in t:
        textline = row
        #print(textline)
        fontswapfile = open('/home/max/Projects/Python/SQLite/csv/ERASMVS_PUA_norm.csv')
        csv_f = csv.reader(fontswapfile, delimiter = "\t")
        for swap in csv_f:
            cfind = swap[2]
            creplace = swap[4]
